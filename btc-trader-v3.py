...
# ============================================================
SESSIONS = [
    (0,2,1.0),(2,7,0.8),(7,9,1.2),(9,11,1.5),
    (11,13,1.3),(13,16,2.0),(16,20,1.5),(20,22,1.2),(22,24,0.9),
]
def get_session(hour):
    for s,e,w in SESSIONS:
        if s <= hour < e: return {"name": f"{s:02d}-{e:02d}", "weight": w}
    return {"name": "22-00", "weight": 0.9}
